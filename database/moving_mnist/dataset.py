...
class seq_DataBuilder(Dataset): 
    ...
    def __init__(self, input_length, rollout_times, dataset, train_ratio=0.8, transform=None):
        ...
        list = np.load('../database/moving_mnist/data/mnist_test_seq.npy', allow_pickle=True)
        ...
        train_data, temp_data = train_test_split(transposed_list, test_size=test_size, random_state=42)
